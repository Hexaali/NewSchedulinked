...
const AboutUs = () => {
    return (
        <section id="aboutus" className='py-10 dark:bg-gray-900 flex items-center justify-center min-h-screen'>
            <div className="flex flex-row items-center justify-center container mx-auto gap-6">
                <div className='w-1/4' data-aos="fade-right" data-aos-duration="3000">
                    <Image src="/about.gif" className='h-90 w-90 items-center pt-6' alt='About Us' width={300} height={300} />
                </div>
                <div className="flex flex-col container mx-auto text-center pr-10"> {/* Added pr-10 for right space */}
                    <Typography
                        variant="h5"
